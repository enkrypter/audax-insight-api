...
var encodedData = require('soop').load('audaxcore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('audaxcore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('audaxcore/lib/Address', {
